            ...
            <nav className='bg-[#F8D6B3] w-[90%] max-w-7xl rounded-3xl shadow-xl'>
                ...
                <div className='flex justify-between items-center px-6 py-4 md:px-8 md:py-5'>
                    ...
                    <div className="hidden md:flex items-center gap-4 shrink-0">
                        <Link href="/login" className='text-gray-900 font-bold text-lg hover:text-orange-600 transition-colors px-4 py-2'>
                            login
                        </Link>
                        <Link href="/signup" className='cursor-pointer bg-[#FF9F1C] text-white font-extrabold px-6 py-3 rounded-full shadow-md hover:bg-orange-500 hover:shadow-lg transition-colors duration-200 lowercase text-lg'>
                            sign up
                        </Link>
                    </div>
                ...
                >
                    <div className='flex flex-col items-center pb-8 pt-2 gap-6 md:hidden'>
                        ...
                        <div className='flex flex-col w-full items-center gap-4'>
                            <Link href="/login" onClick={() => setIsMenuOpen(false)} className='text-gray-900 font-bold text-xl active:text-orange-600'>
                                login
                            </Link>
                            <Link href="/signup" onClick={() => setIsMenuOpen(false)} className='cursor-pointer bg-[#FF9F1C] text-white font-extrabold px-8 py-3 rounded-full shadow-md active:bg-orange-500 transition-colors lowercase text-lg w-[80%] text-center'>
                                sign up
                            </Link>
                        </div>
                    </div>
