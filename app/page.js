        ...
        <div ref={ref} className='relative w-full flex justify-center items-center min-h-[85vh] overflow-hidden py-20'>
           ...
           ======================================= */}
                <div className='flex flex-col items-center lg:items-start text-center lg:text-left order-last lg:order-first'>
                    ...
                    <div className="opacity-0 animate-[fade-up_0.8s_ease-out_forwards_100ms] will-change-transform">
                    ...
                    <h1 className="text-5xl lg:text-7xl xl:text-8xl font-extrabold text-[#2d2d2d] leading-[1.05] tracking-tight mb-8 opacity-0 animate-[fade-up_0.8s_ease-out_forwards_200ms] will-change-transform">
                        Find your <br />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-[#E85D04] to-[#FF9F1C] relative">
                            soulmate.
                            {/* Artistic Underline - Optimized: uses scaleX and origin-left instead of width */}
                            <svg className="absolute  h-4 -bottom-1 left-0 text-[#FF9F1C] animate-[width-grow_1s_ease-out_forwards_800ms] w-full origin-left scale-x-0 opacity-0 will-change-transform" viewBox="0 0 200 9" fill="none" preserveAspectRatio="none"><path d="M2.00025 6.99997C2.00025 6.99997 101 -0.500003 198 2.49997" stroke="currentColor" strokeWidth="4" strokeLinecap="round" /></svg>
                        </span>
                    </h1>

                    {/* 3. Description */}
                    <p className="text-lg text-[#5a4a3a] font-medium max-w-lg leading-relaxed mb-10 opacity-0 animate-[fade-up_0.8s_ease-out_forwards_300ms] will-change-transform">
                        They aren&apos;t just looking for a home. They are looking for you. Browse hundreds of profiles and find the one that clicks.
                    </p>

                    {/* 4. Action Area */}
                    <div className="flex flex-col sm:flex-row items-center gap-8 w-full opacity-0 animate-[fade-up_0.8s_ease-out_forwards_500ms] will-change-transform">
           ...
           ======================================= */}
                <div className="relative opacity-0 animate-[fade-in-scale_1s_ease-out_forwards_300ms] will-change-transform">
